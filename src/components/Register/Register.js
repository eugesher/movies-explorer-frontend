    ...
    <form className="register">
      <div className="register__container">
        ...
        <label className="register__input-container">
          ...
          <input type="text" required={true} className="register__input" />
        </label>
        <label className="register__input-container">
          <span className="register__input-label">E-mail</span>
          <input type="email" required={true} className="register__input" />
        </label>
        <label className="register__input-container">
          <span className="register__input-label">Пароль</span>
          <input type="password" required={true} className="register__input" />
        </label>
